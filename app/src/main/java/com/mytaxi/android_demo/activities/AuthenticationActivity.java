...
public class AuthenticationActivity extends AppCompatActivity {
    ...
    3. both Username and Password fields are empty */
                    ...
                    Snackbar.make(view, R.string.username_password_empty, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Failed login as Username and Password are empty ");
                } else if (username.isEmpty()) {
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.username_empty, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Failed login as Username is empty ");
                } else if (password.isEmpty()) {
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.password_empty, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Failed login as Password is empty ");
                } else {
                    View view = findViewById(android.R.id.content);
